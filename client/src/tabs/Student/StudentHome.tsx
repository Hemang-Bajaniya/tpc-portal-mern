      ...
      <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-6 py-3 bg-white shadow">
          ...
          <Drawer open={profileOpen} onOpenChange={setProfileOpen}>
            ...
            <DrawerContent>
              ...
              <DrawerDescription className="sr-only">
                Navigation links for student profile and settings.
              </DrawerDescription>
              <div className="p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:flex gap-2">
            <Link to="" className="text-gray-700 hover:text-blue-700 px-3">
              Home
            </Link>
            <Link to="jobs" className="text-gray-700 hover:text-blue-700 px-3">
              Jobs
            </Link>
            <Link
              to="applied"
