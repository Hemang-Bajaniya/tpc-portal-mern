...
const sidebarLinks = [
  { label: "Approve TPC", to: "/tpo/approve-tpc" },
  { label: "Approve Acadmic Details", to: "/tpo/approve-acadmic-details" },
  { label: "Student Management", to: "/tpo/student-management" },
  { label: "Company Management", to: "/tpo/company-management" },
  { label: "Job Profile Management", to: "/tpo/job-profile-management" },
  { label: "Placement Drives", to: "/tpo/placement-drives-management" },
  { label: "Applications", to: "/tpo/application-management" },
  { label: "Results", to: "/tpo/placedstudents" },
  { label: "Reports", to: "/tpo/reports" },
  { label: "Contact TPC", to: "/tpo/contact-tpc" },
];
    ...
    <div className="grid h-screen w-full pl-[280px]">
      <aside className="inset-y fixed left-0 z-20 flex h-full flex-col border-r w-[280px]">
        <div className="border-b p-2 h-[57px] flex items-center">
          <h1 className="text-xl font-semibold ml-2">TPO Panel</h1>
        </div>
